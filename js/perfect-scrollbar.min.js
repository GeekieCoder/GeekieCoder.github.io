(function(a, b) {
    ...
    function q(a) {
        ...
        a.scrollbarXLeft = n((a.negativeScrollAdjustment + b.scrollLeft) * (a.railXWidth - a.scrollbarXWidth) / (a.contentWidth - a.containerWidth))) : a.scrollbarXActive = !1,
        ...
        a.scrollbarYTop = n(c * (a.railYHeight - a.scrollbarYHeight) / (a.contentHeight - a.containerHeight))) : a.scrollbarYActive = !1,
        ...
        s(b, a),
        a.scrollbarXActive ? b.classList.add(v.state.active("x")) : (b.classList.remove(v.state.active("x")),
        a.scrollbarXWidth = 0,
        a.scrollbarXLeft = 0,
        b.scrollLeft = !0 === a.isRtl ? a.contentWidth : 0),
        a.scrollbarYActive ? b.classList.add(v.state.active("y")) : (b.classList.remove(v.state.active("y")),
    ...
    var A = {
      ...
      , C = {
        ...
        wheel: function(b) {
            function c(a, c) {
                var d, e = Math.floor(h.scrollTop), f = 0 === h.scrollTop, g = e + h.offsetHeight === h.scrollHeight, i = 0 === h.scrollLeft, j = h.scrollLeft + h.offsetWidth === h.scrollWidth;
        ...
        touch: function(b) {
            function c(a, c) {
                ...
                if (g > f) {
                    if (0 > c && d === b.contentHeight - b.containerHeight || 0 < c && 0 === d)
                        return 0 === window.scrollY && 0 < c && A.isChrome;
            ...
            function k() {
                ...
                p = setInterval(function() {
                    return b.isInitialized ? void clearInterval(p) : o.x || o.y ? .01 > Math.abs(o.x) && .01 > Math.abs(o.y) ? void clearInterval(p) : void (d(30 * o.x, 30 * o.y),
                    o.x *= .8,
            ...
            if (A.supportsTouch || A.supportsIePointer) {
                var l = b.element
                  ...
                  , o = {}
                  , p = null;
                A.supportsTouch ? (b.event.bind(l, "touchstart", h),
                b.event.bind(l, "touchmove", j),
                b.event.bind(l, "touchend", k)) : A.supportsIePointer && (window.PointerEvent ? (b.event.bind(l, "pointerdown", h),
      ...
      , D = function(d, e) {
        ...
        !0 === this.isRtl && d.classList.add(v.rtl),
        ...
        this.lastScrollTop = Math.floor(d.scrollTop),
